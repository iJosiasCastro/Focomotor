<template>
  <App>
    <PartialsTitle background_num="4" title="Política de Privacidad" />
    <div class="max-w-2xl mx-auto px-2">
      ...
      <div>
        ...
        <p>
            ...
            Focomotor usa y protege la información que es proporcionada por sus
        ...
        <p>
            Focomotor está altamente comprometido para cumplir con el compromiso de
        ...
        <p>
            ...
            Cada vez que se le solicite rellenar un formulario con información
            personal identificable, como el de alta de usuario, puede posteriormente
            contactarnos para solicitar el “derecho a ser olvidado” y borrar su
        ...
        <p>
            Focomotor se reserva el derecho de cambiar los términos de la presente
...
export default {
    head(){
        return {
            title: 'Política de Privacidad - Focomotor'
        }
    },
}
</script>